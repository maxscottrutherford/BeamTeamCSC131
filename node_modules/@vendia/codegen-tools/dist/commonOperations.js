export const operations = `
  ...
  query _blocks__list(
    $order: [Vendia_Block_OrderInput_!]
    $filter: Vendia_Block_FilterInput_
    $limit: Int
    $nextToken: String
  ) {
  ...
  query _contracts__list(
    $limit: Int
    $nextToken: String
    $order: [Vendia_Contract_OrderInput_!]
    $filter: Vendia_Contract_FilterInput_
  ) {
  ...
  query _deployments__list(
    $order: [Vendia_DeploymentInfo_OrderInput_!]
    $filter: Vendia_DeploymentInfo_FilterInput_
    $nextToken: String
    $limit: Int
  ) {
  ...
  query _files__list(
    $order: [Vendia_File_OrderInput_!]
    $filter: Vendia_File_FilterInput_
    $limit: Int
    $nextToken: String
  ) {
  ...
  mutation _files__update($id: ID!, $condition: Vendia_File_ConditionInput_, $input: Vendia_File_UpdateInput_!) {
    updateVendia_File(id: $id, input: $input, condition: $condition, syncMode: ASYNC) {
      transaction {
        _id
        transactionId
        version
  ...
  query _folders__list(
    $order: [Vendia_Folder_OrderInput_!]
    $filter: Vendia_Folder_FilterInput_
    $limit: Int
    $nextToken: String
  ) {
  ...
  query _sharingPolicies__list(
    $limit: Int
    $nextToken: String
    $order: [Vendia_SharingPolicy_OrderInput_!]
    $filter: Vendia_SharingPolicy_FilterInput_
  ) {
    listVendia_SharingPolicyItems(order: $order, filter: $filter, limit: $limit, nextToken: $nextToken) {
  ...
  mutation _sharingPolicies__add(
    $aclInput: Vendia_Acls_Input_
  ...
  mutation _sharingPolicies__update(
    $id: ID
    $name: String
    $aclInput: Vendia_Acls_Input_
    $condition: Vendia_SharingPolicy_ConditionInput_
  ...
  mutation _sharingPolicies__remove(
    $id: ID
    $name: String
    $condition: Vendia_SharingPolicy_ConditionInput_
    $syncMode: Vendia_SyncMode = NODE_LEDGERED
  ) {
    removeVendia_SharingPolicy(id: $id, name: $name, condition: $condition, syncMode: $syncMode) {
      transaction {
        _id
        transactionId
        version
