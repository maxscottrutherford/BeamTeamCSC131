...
exports.createSubscriptionClient = void 0;
const uuid_1 = require("@lukeed/uuid");
const graphql_1 = require("graphql");
const graphql_ws_1 = require("graphql-ws");
const isomorphic_ws_1 = __importDefault(require("isomorphic-ws"));
// Extends core client with subscriptions
const createSubscriptionClient = function (options, { _logger, _onAuthStateChange, }) {
    ...
    const _createSubscriptionClient = () => {
        ...
        const subClient = (0, graphql_ws_1.createClient)(subClientOptions);
    ...
    */
    ...
    const _subscribe = ({ query, variables }, handler) => {
        const queryAsString = (0, graphql_1.print)(query);
        ...
        const observableId = (0, uuid_1.v4)();
