...
function groupBy(array, key) {
    return array.reduce((acc, item) => {
        var _a;
        var _b;
        const group = ((_a = acc[_b = key(item)]) !== null && _a !== void 0 ? _a : (acc[_b] = []));
        group.push(item);
        return acc;
    }, {});
}
