...
import { AvoidOptionalsConfig, ConvertOptions, DeclarationKind, EnumValuesMap, NormalizedScalarsMap, ParsedEnumValuesMap, ResolversNonOptionalTypenameConfig } from './types.cjs';
...
export declare class BaseResolversVisitor<TRawConfig extends RawResolversConfig = RawResolversConfig, TPluginConfig extends ParsedResolversConfig = ParsedResolversConfig> extends BaseVisitor<TRawConfig, TPluginConfig> {
    ...
    protected _hasReferencedResolversUnionParentTypes: boolean;
    ...
    protected createResolversFields({ applyWrapper, clearWrapper, getTypeToUse, referencedUnionType, shouldInclude, }: {
    ...
    protected createResolversUnionTypes({ getTypeToUse, }: {
    ...
    buildResolversUnionParentTypes(): string;
